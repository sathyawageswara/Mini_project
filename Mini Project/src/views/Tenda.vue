  ...
  <v-card class="mx-auto overflow-hidden" height="800">
    ...
    <v-app>
      <v-data-table :headers="headers" :items="nama" sort-by="Ukuran" class="elevation-1">
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title>Barang Camping </v-toolbar-title>
                  ...
                  <v-container>
                    <v-row>
                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="editedItem.nama" label="Name"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="4">
                        <v-text-field v-model="editedItem.Ukuran" label="Ukuran"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="4">
